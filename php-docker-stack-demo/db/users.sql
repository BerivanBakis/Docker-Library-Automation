...
CREATE TABLE `users` (
  `id` int NOT NULL,
  `name` varchar(255) DEFAULT '' COLLATE utf8mb4_0900_ai_ci,
  `surname` varchar(255) DEFAULT '' COLLATE utf8mb4_0900_ai_ci,
  `no` varchar(255) DEFAULT '' COLLATE utf8mb4_0900_ai_ci
