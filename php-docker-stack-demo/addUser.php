...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($no) && !empty($name) && !empty($surname)) {
        $add_query = "INSERT INTO `users` (`id`, `name`, `surname`, `no`) VALUES (NULL, '$name', '$surname', '$no')";
...
<div class="login-page">
  <div class="form">
    <form class="login-form" method="post">
      ...
      <input type="text" name="no" required placeholder="No"/>
