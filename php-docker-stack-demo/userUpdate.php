    ...
    if (!empty($user_id)) {
        ...
        if ($new_result) {
            while ($row = mysqli_fetch_assoc($new_result)) {
                echo '<input type="text" required readonly name="id" value="' . $row['id'] . '"/>';
                echo '<input type="text" required name="name" value="' . $row['name'] . '"/>';
                echo '<input type="text" required name="surname" value="' . $row['surname'] . '"/>';
                echo '<input type="text" required name="no" value="' . $row['no'] . '"/>';
            }
        }
    }
    ?>
